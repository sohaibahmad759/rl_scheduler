...
models = ['models/efficientnet-b0.onnx', 'models/efficientnet-b1.onnx',
          'models/efficientnet-b1.onnx', 'models/efficientnet-b3.onnx',
          'models/efficientnet-b5.onnx', 'models/efficientnet-b7.onnx']
...
wf = open('efficientnet_profiled.csv', mode='w')
...
for model_name in models:
    for batch_size in batch_sizes:
        ...
        def run_sample(session, image_file, categories, inputs):
            ...
            # print(f'inputs: {session.get_inputs()[0]}')
