...
def get_args():
    ...
    ap.add_argument('--out', '-o', required=False, default='../../twitter/asplos/zipf_exponential_bursty',
    ...
    with open(input_file, mode='r') as rf:
        ...
        for line in rf:
            ...
            for model in range(num_models):
                ...
                arrivals = np.rint(np.random.exponential(scale=1000/requests_for_model,
