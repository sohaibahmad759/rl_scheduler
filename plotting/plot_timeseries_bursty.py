...
logfile_list = [
                ...
                # f'{path}/{trace}/{slo}/infaas_accuracy_300ms_0.01_0.6.csv', # this
                ...
                # f'{path}/{trace}/{slo}/sommelier_asb_ewma1.6_beta1.5_300ms.csv', # this
...
plt.savefig(os.path.join('..', 'figures', 'asplos', 'bursty',
