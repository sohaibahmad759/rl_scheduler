...
plt.savefig(os.path.join('../traces/azure/mlsys/250/traces_by_model.pdf'), dpi=500, bbox_inches='tight')

plt.close()
plt.plot(total_requests)
plt.savefig(os.path.join('../traces/azure/mlsys/250/traces_total.pdf'), dpi=500, bbox_inches='tight')
